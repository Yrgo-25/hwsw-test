...
* Resten av lektionen: att få pipelinen grön i det egna repot.
...
### Under lektionen
* Delta aktivt på genomgången av pipelinen i [bilaga A](./appendix/a_ci_startup.md), som
  demonstreras live.
* Genomför därefter övningsuppgifterna i [bilaga B](./appendix/b_exercises.md), i grupp och i ert
  eget repo.
* Demot ligger på GitHub: [Yrgo-25/ci-demo](https://github.com/Yrgo-25/ci-demo). Repot har byggts
  ut efter lektionen med en timer-driver, enhetstester samt CI-skript, som ett exempel på hur en
  kodbas kan struktureras; lektionens version är historiken fram till commiten `Update ci.yml`.
* Lektionsanteckningar från demot finns [här](./exercises/README.md).
...
* Resterande tid ägnas åt att få pipelinen grön i ert eget repo.
